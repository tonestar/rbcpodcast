...
episode = episode.filter((e) => e.data.category === "seminar");
...
const coverField = astropodConfig.coverSeminars || astropodConfig.cover;
...
export async function GET(context) {
  let podcast = {
    rss: {
      ...
      channel: [
        {
          title: astropodConfig.name + " - Seminars",
          ...
          "atom:link": [
            {
              $: {
                href: `${astropodConfig.link}/rss-seminars.xml`,
                rel: "self",
